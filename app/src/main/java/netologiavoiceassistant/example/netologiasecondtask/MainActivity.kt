package netologiavoiceassistant.example.netologiasecondtask
...
import com.example.netologiavoiceassistant.R
...
class MainActivity : AppCompatActivity() {
    ...
    val VOICE_RECOGNITION_REQUEST_CODE = 777
    ...
    fun askWolfram(request: String) {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            kotlin.runCatching {
                ...
                withContext(Dispatchers.Main) {
                    progressBar.visibility = View.GONE
                    showSnackBar(t.message ?: getString(R.string.error_soemthing_went_wrong))
                }
            }
        }
    }
    ...
    fun showVoiceInputDialog() {
        ...
        runCatching {
            ...
            showSnackBar(t.message ?: getString(R.string.error_voice_recognition_unavaliable))
        }
    }
